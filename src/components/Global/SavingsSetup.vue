<template>
  <v-layout>
    <v-navigation-drawer v-model="showDrawer" temporary :width="450" color="#F4F4F8">
      ...
      <section class="tw-p-4 mt-6">
        <div class="">
          <p class="mb-2">How frequent do you want to save?</p>
          <div class="tw-flex tw-gap-3">
            <div
              v-for="item in frequencies"
              :key="item"
              class="tw-w-full tw-bg-white tw-rounded-full tw-py-2 text-center tw-text-[#372E52] tw-text-[14px]"
              :class="{ 'tw-border tw-border-primary': form.frequency === item }"
